...
import (
	...
	logger "github.com/CAS735-F23/macrun-teamvsl/trail/log"
...
type LocationSubscriber struct {
	...
	svc      *services.TrailManagerService
}

type TrailManagerAMQPHandler struct {
	svc                *services.TrailManagerService
	locationSubscriber *LocationSubscriber
}

func NewAMQPHandler(trailManagerSvc *services.TrailManagerService) *TrailManagerAMQPHandler {
	...
	return &TrailManagerAMQPHandler{
		svc:                trailManagerSvc,
		locationSubscriber: &locationSubscriber,
	}
}
...
func (wah *TrailManagerAMQPHandler) InitAMQP() error {
